...
var api_url_base = nconf.get('uplink:apiroot') || 'https://alpha-api.app.net'
...
var token_host_override = nconf.get('adn:token_host_override') || 'account.app.net'

var client_id = nconf.get('uplink:client_id')
var client_secret = nconf.get('uplink:client_secret')
