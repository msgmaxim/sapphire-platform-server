...
module.exports = {
  ...
  getUserID: async function(username, callback) {
    if (!username) {
      callback('dataaccess.proxy-admin.js::getUserID() - username was not set', false, false);
      return;
    }
    /*
  ...
  getUser: async function(userid, callback) {
    if (userid==undefined) {
      callback(false, 'dataaccess.proxy-admin.js:getUser - userid is undefined');
      return;
    }
    if (!userid) {
      callback(false, 'dataaccess.proxy-admin.js:getUser - userid isn\'t set');
      return;
    }
    var ref=this;
  ...
  getUsers: function(userids, params, callback) {
    if (userids==undefined) {
      ...
      callback('dataccess.proxy-admin.js:getUsers - userids is undefined', false);
      return;
    }
    if (!userids) {
      console.log('dataccess.proxy-admin.js:getUsers - userids isn\'t set')
      callback('dataccess.proxy-admin.js:getUsers - userids isn\'t set', false);
      return;
    }
    var ref=this;
  ...
  getAPIUserToken: function(token, callback) {
    if (token==undefined) {
      callback('dataaccess.proxy-admin.js::getAPIUserToken - token is undefined', false);
      return;
    }
    var ref=this;
  ...
  */
  ...
  getUserSubscriptions: function(userid, params, callback) {
    if (id==undefined) {
      callback(null, 'dataccess.proxy-admin.js::getUserSubscriptions - id is undefined');
      return;
    }
    if (this.next) {
  ...
  getChannelSubscriptions: function(channelid, params, callback) {
    if (id==undefined) {
      callback(null, 'dataccess.proxy-admin.js::getChannelSubscriptions - id is undefined');
      return;
    }
    if (this.next) {
