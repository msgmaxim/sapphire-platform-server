...
const mysqlToDatabase = function(prop, val) {
  'use strict'
  if (val === null) {
    return 'NULL'
  }
  if (val.constructor.name === 'Object') {
    ...
    if (operator === 'between') {
      ...
      if (!({}.propertyIsEnumerable.call(val, 'length')) && typeof val === 'object' && typeof val.length === 'number') { //if value is array
